...
$this->title = "Lowering";
$checkpoints = Yii::$app->general->TaxonomyDrop(21);
     ...
     <div class="col-xl-12 col-lg-12 col-12 p-r-5">
        <div class="card-body card"> 
            <div class="card-header">
                <h4 class="card-title mb-0"><?= Yii::$app->trans->getTrans('Lowering Info'); ?>
            ...
            ?>                         
                ...
                <?= $form->field($model, 'holiday_detection')->dropDownList([ 'Accepted' => 'Accepted', 'Rejected' => 'Rejected', ], ['prompt' => '','disabled' => Yii::$app->general->isAllowed()]) ?>
                <?= $form->field($model, 'holiday_serial_number',['template' => '<div class="col-md-12 clearfix">{label}{input}{error}{hint}</div>'])->textInput(['maxlength' => true,'disabled' => Yii::$app->general->isAllowed()]) ?>              
                <?php if(!Yii::$app->general->isAllowed()){?>
                ...
                ?>              
                <?= Yii::$app->general->defautFileField($model,$form,'Lowering');?>
    ...
    <div class="width-bigSm bgsm-side right-table">
        <div class="card-body card"> 
            <div class="card-header">
                ...
                <h4 class="card-title"><?= Yii::$app->trans->getTrans('Lowering List'); ?></h4>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <?= Yii::$app->general->signOffButton('app\models\Lowering');?>
                        <?= Yii::$app->general->gridButton('app\models\Lowering');?>
                    </div>
                </div>
            </div>
            <?php
                $searchModel = new app\models\LoweringSearch();
