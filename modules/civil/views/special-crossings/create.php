...
$this->title = 'Special Crossings';

$checkpoints = Yii::$app->general->TaxonomyDrop(35);
        ...
        <div class="col-xl-12 col-lg-12 col-12 p-r-5">
            <div class="card-body card">
                <div class="card-header">
                    <h4 class="card-title mb-0"><?= Yii::$app->trans->getTrans('Special Crossing Info'); ?>
                ...
                ?>
                <?= Yii::$app->general->defautFileField($model, $form, 'SpecialCrossings');?>
    ...
    <div class="width-bigSm bgsm-side right-table">
        <div class="card-body card"> 
            <div class="card-header">
                ...
                <h4 class="card-title"><?= Yii::$app->trans->getTrans('Special Crossings List'); ?></h4>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <?= Yii::$app->general->signOffButton('app\models\SpecialCrossings');?>
                        <?= Yii::$app->general->gridButton('app\models\SpecialCrossings');?>
                    </div>
                </div>
            </div>
            <?php
                $searchModel = new app\models\SpecialCrossingsSearch();
