...
$filters = Yii::$app->general->getFilters();
?>
<?= GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'template'=>'{update}',
                ...
                'update' => function ($url, $model) {
                    $url = Url::to(['/civil/special-crossings/create', 'EditId' => $model->id]);
                    if(!empty($_GET)){
                        $urlParams = Yii::$app->general->getFilters();
                        $urlParams[] = '/civil/special-crossings/create';
        ...
        [
            ...
            'filter' => DateRangePicker::widget([
                'model' => $searchModel, 
                'name' => 'SpecialCrossingsSearch[date]',
                'convertFormat' => true,
