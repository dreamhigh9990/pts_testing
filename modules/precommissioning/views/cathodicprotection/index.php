        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        $url = Url::to(['/precommissioning/cathodicprotection/create', 'EditId' => $model->id]);
                        if(!empty($_GET)){
                            $urlParams = Yii::$app->general->getFilters();
                            $urlParams[] = '/precommissioning/cathodicprotection/create';
            ...
            [
                ...
                'filter' => DateRangePicker::widget([
                    'model' => $searchModel, 
                    'name' => 'CathodicprotectionSearch[date]',
                    'convertFormat'=>true,
