...
/**
 * This is the model class for table "com_clean_gauge".
 *
 * @property int $id
 ...
 */
class Cleangauge extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return CleangaugeQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new CleangaugeQuery(get_called_class());
    }
